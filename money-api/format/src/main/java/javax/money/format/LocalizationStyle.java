...
public final class LocalizationStyle implements Serializable {
    ...
    public static final LocalizationStyle of(Class<?> type, String styleId) {
        return STYLE_CACHE.get(getKey(type, styleId));
    }

    public static final LocalizationStyle of(Class<?> type) {
        return STYLE_CACHE.get(getKey(type, LocalizationStyle.DEFAULT_ID));
    }


    private static String getKey(Class<?> type, String styleId) {
        return type.getName()
                + "_" + (styleId != null ? styleId : "default");
    }
     ...
     *
     * @param id The style's identifier (not null).
     */
     ...
     */
    public static LocalizationStyle of(Class<?> targetType) {
        return new Builder(targetType, DEFAULT_ID).build();
    }
     ...
     * @return the {@link LocalizationStyle} created.
     */
    public static LocalizationStyle of(Class<?> targetType, String styleId) {
        return new Builder(targetType, styleId).build();
    }
    ...
    public static final class Builder {
         ...
         * {@code null}
         * @throws IllegalStateException if this builder can not create a new
         * instance.
         * @see #isBuildable()
         */
         ...
         * Constructor.
         *
         * @param style the style's identifier, not null.
         */
         ...
         * @throws IllegalArgumentException if the key passed equals to a key
         * used for a predefined property.
         */
